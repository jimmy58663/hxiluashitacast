...
local sets = {
    ...
    Idle_Priority = {
        ...
        Body = {'Wonder kaftan', 'Beetle harness +1', 'Ryl.Ftm. Vest'},
        Hands = {'Wonder Mitts', 'Ryl.Ftm. Gloves'},
        Ring1 = {'Jaeger Ring', 'Balance Ring'},
        Ring2 = {'Rajas Ring', 'Balance Ring'},
        Back = '',
        Waist = {'Sarashi', 'Warrior\'s Belt +1', 'Friar\'s Rope'},
        Legs = {'Wonder Braccae', 'Bastokan Subligar', 'Brass Subligar'},
        Feet = 'Bounding Boots'
    },
    ...
    Tp_Priority = {
        ...
        Ear1 = {'Beetle Earring +1', 'Onyx Earring'},
        Ear2 = {'Beetle Earring +1', 'Onyx Earring'},
        Body = {'Mrc.Cpt. Doublet', 'Beetle harness +1', 'Ryl.Ftm. Vest'},
        Hands = {'Wonder Mitts', 'Ryl.Ftm. Gloves'},
        Ring1 = {'Jaeger Ring', 'Balance Ring'},
        Ring2 = {'Rajas Ring', 'Balance Ring'},
        Back = '',
