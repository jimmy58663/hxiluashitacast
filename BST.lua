...
local sets = {
	...
	Idle_Priority = {
        ...
        Body = {'Haubergeon', 'Scorpion Harness', 'Alumine Haubert', 'Wonder Kaftan', 'Beetle harness +1'},
        Hands = {'Thick Mufflers', 'Ryl.Sqr. Mufflers', 'Wonder Mitts', 'Ryl.Ftm. Gloves'},
        ...
        Legs = {'Byakko\'s Haidate', 'Ryl.Kgt. Breeches', 'Alumine Brayettes', 'Republic Subligar', 'Brass Subligar'},
	...
	Tp_Priority = {
        ...
        Ear2 = {'Spike Earring', 'Beetle Earring +1'},
        Body = {'Haubergeon', 'Scorpion Harness', 'Alumine Haubert', 'Wonder Kaftan', 'Beetle harness +1'},
        Hands = {'Dusk Gloves', 'Thick Mufflers', 'Ryl.Sqr. Mufflers', 'Wonder Mitts', 'Ryl.Ftm. Gloves'},
        Ring1 = {'Toreador\'s Ring', 'Jaeger Ring', 'Balance Ring'},
        Ring2 = {'Rajas Ring', 'Balance Ring'},
        Back = {'Amemet Mantle +1'},
        Waist = {'Swift belt', 'Life belt', 'Tilt Belt', 'Warrior\'s Belt +1'},
	...
	WS_Priority = {
		...
		Neck = 'Spike Necklace',
		Ear1 = {'Bushinomimi'},
		Body = {'Hecatomb Harness', 'Haubergeon', 'Alumine Haubert', 'Wonder Kaftan'},
	...
	WSAcc_Priority = {
		...
		Neck = 'Peacock Amulet',
		Ear1 = {'Bushinomimi'},
		Body = {'Hecatomb Harness', 'Haubergeon', 'Scorpion Harness', 'Alumine Haubert', 'Wonder Kaftan'},
		Hands = {'Ogre gloves', 'Wonder Mitts'},
		Ring1 = {'Ruby Ring', 'Sun Ring', 'Courage Ring'},
        Ring2 = {'Rajas Ring', 'Courage Ring'},
		Waist = {'Warwolf Belt', 'Life belt', 'Brave belt'},
		Legs = {'Byakko\'s Haidate', 'Ryl.Kgt. Breeches', 'Alumine Brayettes', 'Wonder Braccae'},
		Feet = {'Wonder clomps'},
	},
	...
	Reward_Priority = {
		Ammo = {'Pet Food Zeta', 'Pet Food Epsilon', 'Pet Food Delta', 'Pet Fd. Gamma', 'Pet Food Beta', 'Pet Food Alpha'},
		Body = 'Beast Jackcoat',
		Hands = 'Ogre gloves',
		Feet = 'Beast Gaiters',
	},
...
profile.HandleCommand = function(args)
	...
	if (string.lower(args[1]) == 'rune') then
		...
		gFunc.Message(string.format('Rune Axe mode %s.', Settings.Rune and 'enabled' or 'disabled'));
		return;
	end
end
...
profile.HandleDefault = function()
    ...
    if (player.Status == 'Engaged') then
		...
		if (Settings.Rune) then
			gFunc.EquipSet('Body', 'Gaudy Harness');
		end
